...
class V8_EXPORT ApiObjectAccessScope {
 public:
...
class V8_EXPORT Array : public Object {
 public:
  ...
  V8_DEPRECATE_SOON("Cloning is not supported.",
 ...
 public:
  ...
  class V8_EXPORT Allocator { // NOLINT
   public:
    ...
    /* module(vm):wanglin@alibaba-inc.com */
    /**
     * Get the fd which associate with the buffer for sharedarraybuffer.
     */
    static int GetSharedHandle(void *data);

    /**
     * Allocate |length| bytes for shared memory. Return NULL if allocation
     * is not successful. Memory should be initialized to zeroes.
     */
    static void* AllocateShared(size_t length, int key = 0);

    /**
     * Allocate |length| bytes for shared memory. Return NULL if allocation
     * is not successful. Memory does not have to be initialized.
     */
    static void* AllocateUninitializedShared(size_t length, int key = 0);

    /**
     * Free the shared memory block of size |length|, pointed to by |data|.
     * That memory is guaranteed to be previously allocated by |Allocate|.
     */
    static void FreeShared(void* data, size_t length);

   private:
    static std::map<void*, int> shared_array_buffer_ex_fd_;
    /* YUNOS END */
  };
...
class V8_EXPORT SharedArrayBuffer : public Object {
 public:
  ...
  /* module(vm):wanglin@alibaba-inc.com */
  /**
   * Create a new SharedArrayBuffer over an existing shared memory. The created
   * array buffer is immediately in externalized state unless otherwise
   * specified. The memory block will not be reclaimed when a created
   * SharedArrayBuffer is garbage-collected.
   */
...
class V8_EXPORT ResourceConstraints {
 public:
  ...
  int max_old_space_capacity() const { return max_old_space_capacity_; }
  void set_max_old_space_capacity(int value) { max_old_space_capacity_ = value; }
...
class V8_EXPORT HeapStatistics {
 public:
  ...
  size_t memory_allocator_used() const {
    return memory_allocator_used_;
  }
  size_t memory_allocator_available() const {
    return memory_allocator_available_;
  }
  size_t new_space_size() const {
    return new_space_size_;
  }
  size_t new_space_used() const {
    return new_space_used_;
  }
  size_t new_space_available() const {
    return new_space_available_;
  }
  size_t new_space_committed_physical() const {
    return new_space_committed_physical_;
  }
  size_t new_space_committed() const {
    return new_space_committed_;
  }
  size_t old_space_size() const {
    return old_space_size_;
  }
  size_t old_space_used() const {
    return old_space_used_;
  }
  size_t old_space_available() const {
    return old_space_available_;
  }
  size_t old_space_committed_physical() const {
    return old_space_committed_physical_;
  }
  size_t old_space_committed() const {
    return old_space_committed_;
  }
  size_t code_space_size() const {
    return code_space_size_;
  }
  size_t code_space_used() const {
    return code_space_used_;
  }
  size_t code_space_available() const {
    return code_space_available_;
  }
  size_t code_space_committed_physical() const {
    return code_space_committed_physical_;
  }
  size_t code_space_committed() const {
    return code_space_committed_;
  }
  size_t map_space_size() const {
    return map_space_size_;
  }
  size_t map_space_used() const {
    return map_space_used_;
  }
  size_t map_space_available() const {
    return map_space_available_;
  }
  size_t map_space_committed_physical() const {
    return map_space_committed_physical_;
  }
  size_t map_space_committed() const {
    return map_space_committed_;
  }
  size_t lo_space_size() const {
    return lo_space_size_;
  }
  size_t lo_space_used() const {
    return lo_space_used_;
  }
  size_t lo_space_available() const {
    return lo_space_available_;
  }
  size_t lo_space_committed_physical() const {
    return lo_space_committed_physical_;
  }
  size_t lo_space_committed() const {
    return lo_space_committed_;
  }
  size_t mutable_space_size() const {
    return mutable_space_size_;
  }
  size_t mutable_space_used() const {
    return mutable_space_used_;
  }
  size_t mutable_space_available() const {
    return mutable_space_available_;
  }
  size_t mutable_space_committed_physical() const {
    return mutable_space_committed_physical_;
  }
  size_t mutable_space_committed() const {
    return mutable_space_committed_;
  }
  size_t shared_old_space_size() const {
    return shared_old_space_size_;
  }
  size_t shared_old_space_used() const {
    return shared_old_space_used_;
  }
  size_t shared_old_space_available() const {
    return shared_old_space_available_;
  }
  size_t shared_old_space_committed_physical() const {
    return shared_old_space_committed_physical_;
  }
  size_t shared_old_space_committed() const {
    return shared_old_space_committed_;
  }
  size_t shared_code_space_size() const {
    return shared_code_space_size_;
  }
  size_t shared_code_space_used() const {
    return shared_code_space_used_;
  }
  size_t shared_code_space_available() const {
    return shared_code_space_available_;
  }
  size_t shared_code_space_committed_physical() const {
    return shared_code_space_committed_physical_;
  }
  size_t shared_code_space_committed() const {
    return shared_code_space_committed_;
  }
  size_t shared_map_space_size() const {
    return shared_map_space_size_;
  }
  size_t shared_map_space_used() const {
    return shared_map_space_used_;
  }
  size_t shared_map_space_available() const {
    return shared_map_space_available_;
  }
  size_t shared_map_space_committed_physical() const {
    return shared_map_space_committed_physical_;
  }
  size_t shared_map_space_committed() const {
    return shared_map_space_committed_;
  }
  size_t shared_lo_space_size() const {
    return shared_lo_space_size_;
  }
  size_t shared_lo_space_used() const {
    return shared_lo_space_used_;
  }
  size_t shared_lo_space_available() const {
    return shared_lo_space_available_;
  }
  size_t shared_lo_space_committed_physical() const {
    return shared_lo_space_committed_physical_;
  }
  size_t shared_lo_space_committed() const {
    return shared_lo_space_committed_;
  }
  size_t heap_available() const {
    return heap_available_;
  }
  size_t amount_of_external_allocated_memory() const {
    return amount_of_external_allocated_memory_;
  }
  size_t scavenger_gc_count() const {
    return scavenger_gc_count_;
  }
  size_t full_gc_count() const {
    return full_gc_count_;
  }
  // <YUNOS> changed: end
 ...
 private:
  ...
  // <YUNOS> changed: begin
  size_t memory_allocator_used_;
  size_t memory_allocator_available_;
  size_t new_space_size_;
  size_t new_space_used_;
  size_t new_space_available_;
  size_t new_space_committed_physical_;
  size_t new_space_committed_;
  size_t old_space_size_;
  size_t old_space_used_;
  size_t old_space_available_;
  size_t old_space_committed_physical_;
  size_t old_space_committed_;
  size_t code_space_size_;
  size_t code_space_used_;
  size_t code_space_available_;
  size_t code_space_committed_physical_;
  size_t code_space_committed_;
  size_t map_space_size_;
  size_t map_space_used_;
  size_t map_space_available_;
  size_t map_space_committed_physical_;
  size_t map_space_committed_;
  size_t lo_space_size_;
  size_t lo_space_used_;
  size_t lo_space_available_;
  size_t lo_space_committed_physical_;
  size_t lo_space_committed_;
  size_t mutable_space_size_;
  size_t mutable_space_used_;
  size_t mutable_space_available_;
  size_t mutable_space_committed_physical_;
  size_t mutable_space_committed_;
  size_t shared_old_space_size_;
  size_t shared_old_space_used_;
  size_t shared_old_space_available_;
  size_t shared_old_space_committed_physical_;
  size_t shared_old_space_committed_;
  size_t shared_code_space_size_;
  size_t shared_code_space_used_;
  size_t shared_code_space_available_;
  size_t shared_code_space_committed_physical_;
  size_t shared_code_space_committed_;
  size_t shared_map_space_size_;
  size_t shared_map_space_used_;
  size_t shared_map_space_available_;
  size_t shared_map_space_committed_physical_;
  size_t shared_map_space_committed_;
  size_t shared_lo_space_size_;
  size_t shared_lo_space_used_;
  size_t shared_lo_space_available_;
  size_t shared_lo_space_committed_physical_;
  size_t shared_lo_space_committed_;
  size_t heap_available_;
  size_t amount_of_external_allocated_memory_;
  size_t scavenger_gc_count_;
  size_t full_gc_count_;
  // <YUNOS> changed: end
...
class V8_EXPORT WorkerSerializationData {
 public:
  WorkerSerializationData() = delete;
  ~WorkerSerializationData() = delete;
  WorkerSerializationData(const WorkerSerializationData&) = delete;
  WorkerSerializationData& operator=(const WorkerSerializationData&) = delete;
  void* operator new(size_t size) = delete;
  void operator delete(void*, size_t) = delete;
};


class V8_EXPORT WorkerSerialization {
 public:
  explicit WorkerSerialization(ArrayBuffer::Allocator* array_buffer_allocator);
  ~WorkerSerialization();

  WorkerSerializationData* SerializeValue(Isolate* isolate, Local<Value> value);
  WorkerSerializationData* SerializeValue(Isolate* isolate, Local<Value> value,
  ...
  void CleanupSerializationData(WorkerSerializationData* data);
...
struct WorkerStartCallback {
  typedef void (*CallbackFunction)(Isolate* isolate, void* data);

  WorkerStartCallback(CallbackFunction function = nullptr, void* data_arg = nullptr)
      : callback(function), data(data_arg) {}
  CallbackFunction callback;
  void* data;
};
...
class V8_EXPORT Isolate {
 public:
   ...
   * The path is needed for js nativeLoad to load native libraries of third party.
   * The api should be called before js nativeLoad.
   */
  Local<String> SetAppAbsolutePath(Local<String> path) { return Local<String>(); }

  /**
   * Get the working path of the application.
   * The path is needed for nativeLoad to load native libraries of third party.
   */
  Local<String> GetAppAbsolutePath() { return Local<String>(); }
  // <YUNOS> changed: end
  ...
  // <YUNOS> changed: begin
  /**
   * Delete all the snapshots in HeapProfiler
   */
  ...
  // VM will determine what will happend.
  void AdviceGC();

  enum RequestGCType { kDefault, kLight, kMedium, kHeavy };
  void RequestGC(RequestGCType type);
  void ForceScavenger();

  enum WorkStatus { STATUS_FOREGROUND, STATUS_BACKGROUND };
  /**
   * Switch v8 working status according the type.
   * \param type type of status,it should be one of follow:
   *  STATUS_FOREGROUND: switch to foreground
   *  STATUS_BACK      : switch to background
   */
  void SwitchWorkStatus(WorkStatus type);
  // <YUNOS> changed: end
  ...
  */
  ...
  // <YUNOS> changed: begin
  /**
   * This function is used in YUNOS 4.0 to shared more seed's memory with
   * other processes, which will result in less memory use.
   */
  void MarkSeedHeapPreFork();

  /**
   * This function is called in node. In order to configure something context
   * for muti-thread fork.
   */
  void ConfigMultiThreadsContextPostFork();

  /**
   * Print all chunks' infomation in v8 heap spaces. Used for VMCMD.
   */
  void PrintChunkInfoInSpaces();

  void ResetMaxOldGenerationSize();
  void SetInteractiveModeHeapStrategy();

  void NotifyVmEnterKeyScene();
  void NotfiyVmExitKeyScene();
  // <YUNOS> changed: end
  ...
  Isolate* CreateNewThreadWorker(const CreateParams& params,
                             WorkerStartCallback callback);

  /**
   * Wait for other child threads stop
   */
  void JoinAll();

  /**
   * mark current thread skip join all
   */
  void MarkCurrentThreadSkipJoinAll();
...
class V8_EXPORT V8 {
 public:
   ...
   * Ignoring whether the allocator has been set or not.
   * The allocator should be set before any code tha uses
   * ArrayBuffers is executed.
   * This allocator is used in all isolates.
   */
  static void ForceSetArrayBufferAllocator(
  ...
  * fatal errors such as out-of-memory situations.
  */
  V8_INLINE static V8_DEPRECATE_SOON("Use isolate version", bool IsDead());
   ...
   */
  V8_INLINE static V8_DEPRECATE_SOON(
      "Use isolate version", void TerminateExecution(Isolate* isolate));
...
class Internals {
 public:
  ...
  static const int kIsolateThreadLocalSize = 24 * kApiPointerSize;

  static const int kIsolateRootsOffset = kApiPointerSize * 4 +
                                         kIsolateThreadLocalSize +
                                         kApiPointerSize * 27 +
                                         2 * kApiIntSize;
  static const int kExternalMemoryOffset = kIsolateRootsOffset +
                   444 * kApiPointerSize + kApiPointerSize;
