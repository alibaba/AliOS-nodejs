...
(function TestBadArray() {
  ...
  var sab = new SharedArrayBufferEx(128);
...
(function TestBadIndex() {
  var sab = new SharedArrayBufferEx(8);
...
(function TestGoodIndex() {
  var sab = new SharedArrayBufferEx(64);
  var si32a = new Int32Array(sab);
...
(function TestCompareExchange() {
  IntegerTypedArrayConstructors.forEach(function(t) {
    var sab = new SharedArrayBufferEx(10 * t.constr.BYTES_PER_ELEMENT);
...
(function TestLoad() {
  ...
  // Test Smi range
  (function () {
    var sab = new SharedArrayBufferEx(4);
...
(function TestToNumber() {
  IntegerTypedArrayConstructors.forEach(function(t) {
    var sab = new SharedArrayBufferEx(1 * t.constr.BYTES_PER_ELEMENT);
    var sta = new t.constr(sab);
