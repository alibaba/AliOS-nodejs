...
if (!isworker()) {
	...
	var worker = new ThreadWorker("test/mjsunit-worker/mjsunit.js","test/mjsunit-worker/wasm/stack.js");
	}
}
...
(function testSimpleStack() {
  var expected_string = 'Error\n' +
      ...
      '    at STACK (stack.js:44:11)\n' +            // --
      '    at main (wasm-function[1]:1)\n' +         // --
      '    at testSimpleStack (stack.js:83:18)\n' +  // --
      '    at stack.js:85:3';                        // --
...
(function testStackFrames() {
  ...
  verifyStack(stack, [
      ...
      [   false,           "STACK",    44,   0, "stack.js"],
      [    true,            "main",     1,   1,       null],
      [   false, "testStackFrames",    94,   0, "stack.js"],
      [   false,              null,    103,   0, "stack.js"]
  ]);
})();
...
(function testWasmUnreachable() {
  try {
    ...
    verifyStack(e.stack, [
        ...
        [   false, "testWasmUnreachable",  107,    0, "stack.js"],
        [   false,                  null,  118,    0, "stack.js"]
    ]);
  }
})();
...
(function testWasmMemOutOfBounds() {
  try {
    ...
    verifyStack(e.stack, [
        ...
        [   false, "testWasmMemOutOfBounds",   122,   0, "stack.js"],
        [   false,                     null,   134,   0, "stack.js"]
    ]);
  }
})();
