...
if (!isworker()) {
	...
	var worker = new ThreadWorker("test/mjsunit-worker/mjsunit.js","test/mjsunit-worker/wasm/asm-wasm-exception-in-tonumber.js");
	}
}
var filename = '(?:[^ ]+/)?test/mjsunit-worker/wasm/asm-wasm-exception-in-tonumber.js';
