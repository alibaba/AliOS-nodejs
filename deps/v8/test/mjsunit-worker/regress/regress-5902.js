...
if (!isworker()) {
	...
	var worker = new ThreadWorker("test/mjsunit-worker/mjsunit.js","test/mjsunit-worker/regress/regress-5902.js");
	}
}
...
assertEquals(
    [
      ...
      // TODO chromium v8_extra_library_files
      // "ByteLengthQueuingStrategy.prototype","CountQueuingStrategy.prototype","ReadableStream.prototype"
    ],
    log);
