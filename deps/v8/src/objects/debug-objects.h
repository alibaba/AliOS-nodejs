...
class DebugInfo : public Struct {
 public:
  ...
  // Get BreakPoints array from heap's weak_debug_points_table
  FixedArray* BreakPoints();
  void SetBreakPoints(FixedArray* value);
  ...
  static const int kFlagsOffset = kDebugBytecodeArrayOffset + kPointerSize;
