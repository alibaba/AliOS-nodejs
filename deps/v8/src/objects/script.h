...
class Script : public Struct {
 public:
  ...
  void SetSource(Isolate* isolate, Handle<String> source);
  ...
  class Iterator {
   ...
   private:
    ...
    WeakFixedArray::Iterator shared_iterator_;
    Script* next_;
    Script* shared_next_;
  ...
  static const int kMonitorOffset = HeapObject::kHeaderSize;
  static const int kSourceOffset = kMonitorOffset + kPointerSize;
