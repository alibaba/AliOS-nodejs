...
#ifdef OPT_HASHTABLE
  // <YUNOS> changed: begin
  // We should slow down the speed of expanding when the number of
  // elements is large enough.
  static const int kLargeCapacity = 32768;
  // <YUNOS> changed: end
#endif // OPT_HASHTABLE
...
class WeakHashTable : public HashTable<WeakHashTable, WeakHashTableShape<2>> {
 ...
 public:
  ...
  static void Remove(Handle<WeakHashTable> table, Handle<HeapObject> key);
