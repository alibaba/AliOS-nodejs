...
//   Isolate* isolate or 0 if unicode flag.
    ...
    {
      __ LoadIsolateAddress(arg_reg_4);
    }
...
Handle<HeapObject> RegExpMacroAssemblerX64::GetCode(Handle<String> source) {
  ...
  __ movp(rcx, rsp);
  __ LoadRoot(kScratchRegister, Heap::kStackLimitRootIndex);
...
void RegExpMacroAssemblerX64::CheckPreemption() {
  ...
  Label no_preempt;
  __ LoadRoot(rax, Heap::kStackLimitRootIndex);
  __ cmpp(rsp, rax);
...
void RegExpMacroAssemblerX64::CheckStackLimit() {
  ...
  __ LoadTL(rax, ThreadLocalTop::kRegexpStackLimitAddress);
