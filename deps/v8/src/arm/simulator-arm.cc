...
class Redirection {
 public:
  Redirection(Isolate* isolate, void* external_function,
    ...
    next_ = worker_runtime->simulator_redirection();
    Simulator::current(isolate)->
        FlushICache(isolate->simulator_i_cache(),
                    reinterpret_cast<void*>(&swi_instruction_),
                    Instruction::kInstrSize);
    worker_runtime->set_simulator_redirection(this);
  }
  ...
  static Redirection* Get(Isolate* isolate, void* external_function,
                          ExternalReference::Type type) {
    WorkerRuntime* worker_runtime = isolate->worker_runtime();
    base::LockGuard<base::Mutex> lock_guard(worker_runtime->simulator_redirection_mutex());
    Redirection* current = worker_runtime->simulator_redirection();
...
typedef void (*SimulatorRuntimeProfilingGetterCall)(
    int32_t arg0, int32_t arg1, void* arg2, int32_t arg3);
  ...
  switch (svc) {
    case kCallRtRedirected: {
      ...
      if (fp_call) {
        ...
        if (::v8::internal::FLAG_trace_sim || !stack_aligned) {
          PrintF("Call to host function at %p args %08x %08x %08x %08x",
              reinterpret_cast<void*>(external), arg0, arg1, arg2, arg3);
          if (!stack_aligned) {
            PrintF(" with unaligned stack %08x\n", get_register(sp));
          }
          PrintF("\n");
        ...
        SimulatorRuntimeProfilingGetterCall target =
            reinterpret_cast<SimulatorRuntimeProfilingGetterCall>(
                external);
        target(arg0, arg1, Redirection::ReverseRedirection(arg2), arg3);
