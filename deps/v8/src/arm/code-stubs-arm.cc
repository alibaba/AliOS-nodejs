...
void CEntryStub::Generate(MacroAssembler* masm) {
  ...
  if (FLAG_debug_code) {
    Label okay;
    __ LoadTL(r3, ThreadLocalTop::kPendingExceptionAddress);
  ...
  __ LoadTL(cp, ThreadLocalTop::kPendingHandlerContextAddress);
  __ LoadTL(sp, ThreadLocalTop::kPendingHandlerSPAddress);
  __ LoadTL(fp, ThreadLocalTop::kPendingHandlerFPAddress);
  ...
  __ LoadTL(r1, ThreadLocalTop::kPendingHandlerCodeAddress);
  __ LoadTL(r2, ThreadLocalTop::kPendingHandlerOffsetAddress);
...
void JSEntryStub::Generate(MacroAssembler* masm) {
  ...
  __ LoadTL(r5, ThreadLocalTop::kCEntryFPAddress);
  {
  ...
  __ LoadTL(scratch, ThreadLocalTop::kJSEntrySPAddress);
  __ cmp(scratch, Operand::Zero());
  __ b(ne, &non_outermost_js);
  __ StoreTL(fp, ThreadLocalTop::kJSEntrySPAddress);
  ...
  // emitted after an instruction is emitted, rather than before.
  {
    ...
    __ StoreTL(r0, ThreadLocalTop::kPendingExceptionAddress);
  }
  ...
  __ StoreTL(r6, ThreadLocalTop::kJSEntrySPAddress);
  __ bind(&non_outermost_js_2);

  // Restore the top frame descriptors from the stack.
  __ pop(r3);
  __ StoreTL(r3, ThreadLocalTop::kCEntryFPAddress);
...
void RecordWriteStub::Generate(MacroAssembler* masm) {
  ...
  Label skip_to_incremental_compacting;
  {
    ...
    Register scratch = ip;
    __ LoadRoot(scratch, Heap::kRecordWriteStubModeRootIndex);
    __ cmp(scratch, Operand(INCREMENTAL));
    __ b(eq, &skip_to_incremental_noncompacting);
    __ b(gt, &skip_to_incremental_compacting);
  }
...
static void CallApiFunctionAndReturn(MacroAssembler* masm,
  ...
  __ LoadAddressTL(r9, ThreadLocalTop::kHandleScopeDataNextAddress);
  ...
  __ LoadTL(r5, ThreadLocalTop::kScheduledExceptionAddress);
  __ cmp(r4, r5);
...
void CallApiCallbackStub::Generate(MacroAssembler* masm) {
  ...
  __ push(scratch0);
  // isolate
  __ LoadIsolateAddress(scratch1);
  __ push(scratch1);
  // holder
  __ push(holder);
