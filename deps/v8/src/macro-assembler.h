...
class AllocationUtils {
 public:
  static Heap::RootListIndex GetAllocationTopAddressId(
      AllocationFlags flags) {
    if ((flags & PRETENURE) != 0) {
      return Heap::kOldSpaceAllocationTopRootIndex;
    }
    return Heap::kNewSpaceAllocationTopRootIndex;
  }


  static Heap::RootListIndex GetAllocationLimitAddressId(
      AllocationFlags flags) {
    if ((flags & PRETENURE) != 0) {
      return Heap::kOldSpaceAllocationLimitRootIndex;
    }
    return Heap::kNewSpaceAllocationLimitRootIndex;
  }
};
