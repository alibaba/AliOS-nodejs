...
#define HISTOGRAM_PERCENTAGE_LIST(HP)                                          \
  ...
  /* <YUNOS> changed: begin*/                                                  \
  HP(external_fragmentation_mutable_space, V8.MemoryExternalFragmentationMutableSpace) \
  /* <YUNOS> changed: end*/                                                    \
  ...
  /* <YUNOS> changed: begin*/                                                  \
  HP(heap_fraction_mutable_space, V8.MemoryHeapFractionMutableSpace)           \
  /* <YUNOS> changed: end*/                                                    \
...
#define STATS_COUNTER_LIST_2(SC)                                               \
  ...
  /* <YUNOS> changed: begin*/                                                  \
  SC(mutable_space_bytes_available, V8.MemoryMutableSpaceBytesAvailable)       \
  SC(mutable_space_bytes_committed, V8.MemoryMutableSpaceBytesCommitted)       \
  SC(mutable_space_bytes_used, V8.MemoryMutableSpaceBytesUsed)                 \
  /* <YUNOS> changed: end*/                                                    \
