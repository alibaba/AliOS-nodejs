...
class Serializer : public SerializerDeserializer {
 ...
 protected:
  ...
  SerializerReference AllocateSharedMap();
  SerializerReference Allocate(SerializerSpace space, int size);
  ...
  bool BackReferenceIsAlreadyAllocated(SerializerReference back_reference, bool is_shared);
#endif  // DEBUG
...
class Serializer::ObjectSerializer : public ObjectVisitor {
 ...
 private:
  bool TryEncodeDeoptimizationEntry(HowToCode how_to_code, Address target,
                                    int skip);
  void SerializePrologue(SerializerSpace space, int size, Map* map);
