...
#undef INSTANCE_TYPE_NAME
  ...
  class Sweeper {
   public:
    ...
    static int RawSweep(Heap* heap, Page* p, FreeListRebuildingMode free_list_mode,
                        FreeSpaceTreatmentMode free_space_mode);
  ...
  void Prepare(bool need_verify = false);
  void PrepareForShared();

  bool StartCompaction();

  bool StartCompactionForShared();
  ...
  inline bool collect_shared_space() { return collect_shared_; }
  inline void set_collect_shared_space(bool v) { collect_shared_ = v; };
  ...
  void MarkImplicitRefGroups(RootVisitor* visitor);
  ...
  void VerifyMarkbitsAreClean(bool verify_shared);
 ...
 private:
  ...
  void MarkRoots(RootMarkingVisitor* visitor);
   ...
   // Mark all shared objects
  void MarkSharedObjects();
  ...
  void ProcessEphemeralMarking(RootVisitor* visitor,
  ...
  static bool IsSharedAndUnmarkedHeapObject(Object** p);
  ...
  void ClearWeakCellsInternal(Object** non_live_map_list,
                      DependentCode** dependent_code_list,
                      Object* weak_cell_obj);

  void ClearWeakCellsForNormal(Object** non_live_map_list,
                      DependentCode** dependent_code_list);

  void ClearWeakCellsForShared(Object** non_live_map_list,
                      DependentCode** dependent_code_list);
  ...
  void SweepSharedSpaces();
  void EnsureSweepSharedSpaces();
  void FinishForShared();

  void EvacuateForSharedStep1();
  void EvacuateForSharedStep2();
  void EvacuateForShared();
  void EvacuatePrologue() override;
  void EvacuateEpilogue() override;
  void Evacuate() override;
  void EvacuatePagesInParallel() override;
