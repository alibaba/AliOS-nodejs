...
void Builtins::Generate_ResumeGeneratorTrampoline(MacroAssembler* masm) {
  ...
  __ LoadTL(scratch, ThreadLocalTop::kDebugHookOnnFunctionCallAddress);
  ...
  // generator.
  __ LoadTL(scratch, ThreadLocalTop::kDebugSuspendedGeneratorAddress);
...
static void Generate_JSEntryTrampolineHelper(MacroAssembler* masm,
  ...
  // Enter an internal frame.
  {
    ...
    __ LoadTL(cp, ThreadLocalTop::kContextAddress);
...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  // Check if the bytecodeArray is in AOT-Compiled page.
  Label continue_label;
  __ ldrb(r9, FieldMemOperand(kInterpreterBytecodeArrayRegister,
                              BytecodeArray::kBytecodeAgeOffset));
  __ cmp(r9, Operand(BytecodeArray::kNoAgeBytecodeAge));
