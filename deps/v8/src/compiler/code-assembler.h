...
class V8_EXPORT_PRIVATE CodeAssembler {
 public:
  ...
  Node* LoadTL(ThreadLocalTop::AddressId index);
  Node* StoreNoWriteBarrierTL(ThreadLocalTop::AddressId index, Node* value);
  Node* LoadTL(RootType root_type, ThreadLocalTop::AddressId index);
  Node* StoreNoWriteBarrierTL(RootType root_type, ThreadLocalTop::AddressId index,
                              Node* value);
  Node* LoadRoot(RootType root_type, int index);
  Node* StoreRoot(RootType root_type, Heap::RootListIndex root_index, Node* value);
