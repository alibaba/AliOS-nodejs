...
void JSGenericLowering::LowerJSStackCheck(Node* node) {
  ...
  // JSMT: TODO roots array start is thread local
  Heap::RootListIndex index = Heap::kStackLimitRootIndex;
  Node* limit = graph()->NewNode(
      common()->LoadRoot(RootType::kPointerRootType,
      index * kPointerSize + Isolate::kHeapRootsDelta),
      effect, control);
