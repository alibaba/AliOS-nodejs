...
Handle<FeedbackVector> FeedbackVector::New(Isolate* isolate,
  ...
  CHECK_LT(interpreter::Interpreter::InterruptBudget(), 0x7FFFFFFF);
  array->set(kInterruptBudgetIndex, Smi::FromInt(interpreter::Interpreter::InterruptBudget()));
  array->set(kOSRNestingLevelIndex, Smi::kZero);
  array->set(kOptCountIndex, Smi::kZero);
  array->set(kCountersIndex, Smi::kZero);
