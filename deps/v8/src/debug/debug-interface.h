 ...
 */
V8_EXPORT void SetLiveEditEnabled(Isolate* isolate, bool enable);

// Schedule a debugger break to happen when JavaScript code is run
// in the given isolate.
V8_EXPORT void DebugBreak(Isolate* isolate);

// Remove scheduled debugger break in given isolate if it has not
// happened yet.
V8_EXPORT void CancelDebugBreak(Isolate* isolate);
 ...
 */
V8_EXPORT MaybeLocal<Array> GetInternalProperties(Isolate* isolate, Local<Value> value);
 ...
 */
V8_EXPORT void ChangeBreakOnException(Isolate* isolate, ExceptionBreakState state);
...
V8_EXPORT void PrepareStep(Isolate* isolate, StepAction action);
V8_EXPORT void ClearStepping(Isolate* isolate);
...
V8_EXPORT void GetLoadedScripts(Isolate* isolate, PersistentValueVector<Script>& scripts);

V8_EXPORT MaybeLocal<UnboundScript> CompileInspectorScript(Isolate* isolate,
                                                 Local<String> source);
...
V8_EXPORT int EstimatedValueSize(Isolate* isolate, v8::Local<v8::Value> value);
