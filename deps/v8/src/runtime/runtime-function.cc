...
RUNTIME_FUNCTION(Runtime_SetCode) {
  ...
  {
      sync::MonitorLockScope<SharedFunctionInfo> mls(isolate->vmthread(), source_shared);
      ...
      target_shared->set_ic_age_and_bailout_reason(
              source_shared->ic_age_and_bailout_reason());
