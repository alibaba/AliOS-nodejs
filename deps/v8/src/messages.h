...
#define MESSAGE_TEMPLATES(T)                                                   \
  ...
  T(DataCloneDeserializationVersionError,                                      \
    ...
    "version.")                                                                \
  T(IllegalMonitorWait, "object not locked by thread before wait")             \
  T(IllegalMonitorUnlock, "unlock of monitor owned by other thread")           \
  T(IllegalMonitorUnlockUnOwned, "unlock of unowned monitor")
