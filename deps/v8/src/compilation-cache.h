...
class CompilationCache {
 public:
  ...
  InfoVectorPair LookupSharedScript(Handle<String> source, Handle<Object> name,
                              int line_offset, int column_offset,
                              ScriptOriginOptions resource_options,
  ...
  void PutSharedScript(Handle<String> source,
  ...
  void Clear(bool skip_shared = false);
  ...
  void SetSharedScriptTable(CompilationCache* other) {
    shared_script_ = other->shared_script_;
    subcaches_[kSharedCacheIdx] = shared_script_;
  }

  void ClearSharedScriptTable() {
    shared_script_->Clear();
  }
 ...
 private:
  ...
  static const int kSubCacheCount = 5;
  static const int kSharedCacheIdx = 1;
  ...
  CompilationCacheScript* shared_script_;
  ...
  friend class CompilationSubCache;
