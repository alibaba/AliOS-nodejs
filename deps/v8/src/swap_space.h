...
#ifndef V8_BASE_SWAP_SPACE_H_
#define V8_BASE_SWAP_SPACE_H_
...
class SwapSpace {
 public:
  ...
  static const int NewFileChunkSize = 10;
 ...
 private:
  ...
  FreeBySizeEntry free_by_size_entry_;
...
template <typename T>
using SwapDeque = std::deque<T, SwapAllocator<T>>;
