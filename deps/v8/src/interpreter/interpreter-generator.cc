...
IGNITION_HANDLER(SetPendingMessage, InterpreterAssembler) {
  Node* previous_message = LoadTL(compiler::RootType::kTaggedPointerRootType,
                                       ThreadLocalTop::kPendingMessageObjAddress);
  Node* new_message = GetAccumulator();
  StoreNoWriteBarrierTL(compiler::RootType::kTaggedPointerRootType,
                        ThreadLocalTop::kPendingMessageObjAddress, new_message);
...
IGNITION_HANDLER(SuspendGenerator, InterpreterAssembler) {
  ...
  Node* step_action_address = LoadTL(ThreadLocalTop::kDebugLastStepActionAddress);
