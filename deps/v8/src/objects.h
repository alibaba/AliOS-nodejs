...
class HeapObject: public Object {
 public:
  ...
  inline bool is_shared_object() const;
  // The Heap the object was allocated in. Used also to access Isolate.
  inline Heap* GetHeapFromAddress() const;
  inline Heap* GetHeap() const;

  // Convenience method to get current isolate.
  inline Isolate* GetIsolate() const;
  inline Isolate* GetIsolateFromAddress() const;
...
// <yunos> changed: end
  ...
  static const int kBytecodeAgeOffset = kParameterSizeOffset + kIntSize;
...
// <YUNOS> changed: begin
/**
 * move ICState2String(..) from MACRO ENABLE_DISASSEMBLER
 * to facility void CpuProfileJSONSerializer::SerializeFunctionInfo(..)
 */
...
class JSArrayBuffer: public JSObject {
 public:
  ...
  inline bool is_shared_process();
  inline void set_is_shared_process(bool value);

  // getter and setter of owner allocator id
  inline int allocator_id();
  inline void set_allocator_id(int id);
  ...
  static bool SetupAllocatingData(
      ...
      SharedFlag shared = SharedFlag::kNotShared,
      bool is_shared_process = false) WARN_UNUSED_RESULT;

  static bool SetupAllocatingDataSharedByProcess(
      Handle<JSArrayBuffer> array_buffer,
      Isolate* isolate, key_t key, size_t allocated_length,
  ...
  // <YUNOS> changed:
  // encode the allocator id into the flag field of JSArrayBuffer object.
  static const int kMaxExternalAllocatorCountBits = 5;
  static const int kMaxExternalAllocatorCount =
      1 << kMaxExternalAllocatorCountBits;
  ...
  // <YUNOS> START:
  // module(vm): wanglin@alibaba-inc.com
  class IsProcessShared : public BitField<bool, 7, 1> {};
  class OwnerAllocatorIDOffsetField: public BitField<int,
      8, kMaxExternalAllocatorCountBits> {};  // NOLINT
  // <YUNOS> END
...
class AccessorInfo: public Struct {
 public:
  ...
  inline bool is_fast_accessor();
  inline void set_fast_accessor(bool value);
 ...
 private:
  ...
  static const int kFastAccessor = 5;
  class AttributesField : public BitField<PropertyAttributes, 6, 3> {};
