...
(function(process) {
  ...
  function loadNativeModules() {
    let blacklist = [
      ...
      'v8/tools/splaytree', 'internal/deps/v8/tools/splaytree',
      'v8/tools/codemap', 'internal/deps/v8/tools/codemap',
      'v8/tools/csvparser', 'internal/deps/v8/tools/csvparser',
      'v8/tools/consarray', 'internal/deps/v8/tools/consarray',
      'v8/tools/profile', 'internal/deps/v8/tools/profile',
      'v8/tools/profile_view', 'internal/deps/v8/tools/profile_view',
      'v8/tools/logreader', 'internal/deps/v8/tools/logreader',
      'v8/tools/tickprocessor', 'internal/deps/v8/tools/tickprocessor',
      'v8/tools/SourceMap', 'internal/deps/v8/tools/SourceMap',
      'v8/tools/tickprocessor-driver', 'internal/deps/v8/tools/tickprocessor-driver',
      'node-inspect/lib/_inspect', 'internal/deps/node-inspect/lib/_inspect',
      'node-inspect/lib/internal/inspect_client', 'internal/deps/node-inspect/lib/internal/inspect_client',
      'node-inspect/lib/internal/inspect_repl', 'internal/deps/node-inspect/lib/internal/inspect_repl',
      'acorn/dist/acorn', 'internal/deps/acorn/dist/acorn',
      'acorn/dist/walk', 'internal/deps/acorn/dist/walk'
    ];
    const nms = Object.keys(NativeModule._source)
      .filter(nm => {
    ...
    nms.forEach(nm => {
      NativeModule.require(nm);
    });
  }

  function postSetupNode() {
    postSetupNativeModule();

    postSetupV8();
    postSetupGlobalVariables();
  ...
  function postSetupGlobalVariables() {
  ...
  let postponedFns = [];
  function postSetupNativeModule() {
    ...
    postponedFns.forEach(fn => fn());
    postponedFns = undefined;
    NativeModule.maybeLazyRequire = function(fn) {
      fn();
    }
  }
