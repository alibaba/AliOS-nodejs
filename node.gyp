      ...
      'targets': [
        {
          ...
          'dependencies': [
            'node_js2c#host',
            'deps/nghttp2/nghttp2.gyp:nghttp2',
            'deps/v8/src/v8.gyp:v8_base',
            'deps/v8/src/v8.gyp:v8_builtins_setup',
            'deps/v8/src/v8.gyp:v8_libbase',
            'deps/v8/src/v8.gyp:v8_libplatform',
            'deps/v8/src/v8.gyp:v8_nosnapshot',
          ],
